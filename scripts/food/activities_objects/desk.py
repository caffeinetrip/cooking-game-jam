...
class Desk(pp.Entity):
    def __init__(self):
        super().__init__(type=ActivitiesTypes.DESK.value, pos=(135, 148), z=1)
        self.slots = [
            Holder(ActivitiesTypes.DESK, size=(19,19), pos=(143,151)),
            Holder(ActivitiesTypes.DESK, size=(19,19), pos=(168,151)),
            Holder(ActivitiesTypes.DESK, size=(19,19), pos=(143,175)),
            Holder(ActivitiesTypes.DESK, size=(19,19), pos=(168,175)),
        ]
